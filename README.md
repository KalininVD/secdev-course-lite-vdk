...
- **Группа:** БПИ-233
- **Контакт:** `vdkalinin@edu.hse.ru` / [@Vlad_Kalinin_0](https://t.me/Vlad_Kalinin_0)
- **Проект:** Работаю на учебном шаблоне
...
- **DV:**
- [x] one-liner локальной сборки;
- [x] образ собирается/запускается;
- [ ] CI build+test зелёный;
- [x] артефакты в `EVIDENCE/`;
